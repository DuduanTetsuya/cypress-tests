...
//Mengambil random/acak item dari array: Cypress._.sampleSize(itemsArray, numItems);
...
//Menjalankan test tertentu: npx cypress run --spec "cypress/ProjectTraining/saucedemo/*.cy.js"
//Test: it('Visit website', () => {